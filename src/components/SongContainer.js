      ...
      <div className="flex">
        ...
        {filteredMusicList.length === 0 ? (
           <h1 className="text-center mx-auto">
            <img className="w-[250px] h-[250px] mx-auto mt-10 p-2" src="https://thumbs.dreamstime.com/b/no-found-symbol-unsuccessful-search-suitable-results-oops-page-failure-concept-flat-outline-vector-illustration-loupe-122872462.jpg"/>
            Search Not Found!!!</h1>
          // <img className="w-[500px] h-[500px] mx-auto " src="https://thumbs.dreamstime.com/b/no-found-symbol-unsuccessful-search-suitable-results-oops-page-failure-concept-flat-outline-vector-illustration-loupe-122872462.jpg"/>
        ) : (
